      ...
      <div className="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Need a character certificate? We've got you covered.
            Request your certificate online and pick it up from the admin office.
          </p>
        </div>
        ...
        {/* Uncomment and use the section below if needed later 
