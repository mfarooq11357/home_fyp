                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        id="firstName"
                        type="text"
                        className={`w-full pl-10 pr-4 py-2 border ${errors.firstName ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-[#2D50A1] focus:border-transparent transition-all duration-200`}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        id="lastName"
                        type="text"
                        className={`w-full pl-10 pr-4 py-2 border ${errors.lastName ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-[#2D50A1] focus:border-transparent transition-all duration-200`}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        id="email"
                        type="email"
                        className={`w-full pl-10 pr-4 py-2 border ${errors.email ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-[#2D50A1] focus:border-transparent transition-all duration-200`}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        id="rollNo"
                        type="text"
                        className={`w-full pl-10 pr-4 py-2 border ${errors.rollNo ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-[#2D50A1] focus:border-transparent transition-all duration-200`}
                ...
                {/* <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <select
                        id="gender"
                        className={`w-full pl-10 pr-4 py-2 border ${errors.gender ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-[#2D50A1] focus:border-transparent transition-all duration-200 bg-white`}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        id="contactNo"
                        type="tel"
                        className={`w-full pl-10 pr-4 py-2 border ${errors.contactNo ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-[#2D50A1] focus:border-transparent transition-all duration-200`}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-10 py-2 border ${errors.password ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-[#2D50A1] focus:border-transparent transition-all duration-200`}
...
//   useEffect(() => {
//     // If user becomes authenticated (or after OTP verify) redirect to profile.
//     if (isAuthenticated) {
//       navigate('/Profile', { replace: true });
//     }
//   }, [isAuthenticated, navigate]);
...
//         localStorage.setItem('user', JSON.stringify(result.user));
//         // If OTP is already verified during signup, log in immediately
//         if (result.isOtpVerified) {
//           localStorage.setItem('isOtpVerified', 'true');
//           dispatch(login({ token: result.token, isOtpVerified: true }));
//           toast.success('Signup successful');
...
//                       <select
//                         id="role"
//                         className={`w-full pl-10 pr-4 py-2 border ${errors.role ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-[#2D50A1] focus:border-transparent transition-all duration-200 bg-white`}
