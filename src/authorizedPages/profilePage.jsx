...
//               </p>
//             </div>
//             <button className="ml-auto bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-md transition-all flex items-center gap-2 shadow-md hover:shadow-lg">
//               <Edit className="w-4 h-4" />
//               Edit Profile
//             </button>
//           </div>
...
//           <div className="h-full">
//             <img
//               src="https://i.ibb.co/rBZSJDk/Line-61.png"
//               alt="Divider"
